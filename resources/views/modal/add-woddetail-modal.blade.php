...
<div class="modal fade" id="deleteXXXInvoiceModal" tabindex="-1" role="dialog" aria-labelledby="deleteXXXInvoiceModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="deleteXXXInvoiceModalLabel">Edit Invoice</h5>
