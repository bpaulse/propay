<div class="modal fade bd-example-modal-lg" id="addPersonModal" tabindex="-1" role="dialog" aria-labelledby="addPersonModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="addPersonModalLabel"><i class="icon-cog"></i> Add Person</h5>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary updatePerson">Add Person</button>
