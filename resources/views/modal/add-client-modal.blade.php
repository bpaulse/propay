	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<button type="button" class="close closeAddClientModal" data-dismiss="modal" aria-label="Close">
				...
				<div class="modal-body">
					<table class="table">
						...
						<tr>
							...
							<td>
								<div class="form-group">
									<label for="add_surname" class="col-form-label">Surname:</label>
						...
						<tr>
							<td>
								<div class="form-group">
									<label for="add_mobile" class="col-form-label">Mobile:</label>
						...
						<tr>
							<td>
								<div class="form-group">
									<label for="add_website" class="col-form-label">Website:</label>
									<input type="text" class="form-control" id="add_website" value="">
								</div>
							</td>
							<td>
								<div class="form-group">
									<label for="add_landline" class="col-form-label">Land Line:</label>
						...
						<tr>
							<td>
								<div class="form-group">
									<label for="add_vat" class="col-form-label">VAT Number:</label>
						...
						<tr>
							<td>
								<div class="form-group">
									<label for="add_companyname" class="col-form-label">Company Name:</label>
							...
							<td>
								<div class="form-group">
									<label for="add_address" class="col-form-label">Address:</label>
									<textarea class="form-control" name="add_address" id="add_address" rows="2"></textarea>
								</div>
							</td>
						</tr>
					</table>
